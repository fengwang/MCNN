...
import os.path
from multidomain_wall_mirror_generator_11th import build_model
...
for iteration in range( iterations ):
    ...
    generator.fit( camera_captured_channel_3, [screen_output_channel_3, screen_output_channel_3_256, screen_output_channel_3_128, screen_output_channel_3_64, screen_output_channel_3_32], batch_size=batch_size, epochs=2, verbose=1, validation_split=0.0 )
    ...
    if ((iteration+1) % 8) == 0:
        ...
        e_512_all, e_256_all, e_128_all, e_64_all, e_32_all = generator.predict( test_camera_captured_images[0:8], batch_size=batch_size )
