...
def prepare_defocus_data( path='/data/cache/defocus_1_mandelbrot-gaussian-10db.npz'):
    shape=(512, 512)
    data = np.load(path)
...
def train_mdcnn( model_path='./model/MDCNN-III-hela-I_1.h5', image_shape=(512, 512), epochs=1024, batch_size=8, gpus=0 ):
    ...
    i_image = imageio.imread( 'hela_defocus-1/tmp980-1180.bmp' )
...
if __name__ == '__main__':
    train_mdcnn( gpus=1, epochs=100, batch_size=1, model_path = './hela_defocus-1/current_model.model' )
