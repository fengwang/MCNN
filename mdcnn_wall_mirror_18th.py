...
test_dataset_path = '/data2/feng/wall_mirror/dataset/set4/3_256_screens_cameras.npz_1280X7200_scaled_to_0_1.npz_flipped_cropped_0_1.npz'
...
print( f'1024 dataset merged: {camera_captured_channel_3.shape}' )
### here
