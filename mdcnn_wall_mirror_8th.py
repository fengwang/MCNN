...
dataset_path_se = '/data2/feng/wall_mirror/dataset/set4/1_256_screens_cameras.npz_1280X7200_scaled_to_0_1.npz_cropped_flipped_upscaled_teshape.npz'
test_dataset_path = '/data2/feng/wall_mirror/dataset/set4/2_256_screens_cameras.npz_1280X7200_scaled_to_0_1.npz_cropped_flipped_upscaled_teshape.npz'
storage_path = './wall_mirror/8th'
...
for iteration in range( iterations ):
    ...
    generator.compile( loss=['mae', 'mae', 'mae', 'mae', 'mae'], loss_weights=loss_weights, optimizer=optimizer )
