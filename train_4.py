...
def prepare_data( paths, shape, number ):
    ...
    kernel = np.array( ( [-10, -5, -2, -1, -2, -5, -10], [-5, 0, 3, 4, 3, 0, -5], [-2, 3, 6, 7, 6, 3, -2], [-1, 4, 7, 8, 7, 4, -1], [-2, 3, 6, 7, 6, 3, -2], [-5, 0, 3, 4, 3, 0, -5], [-10, -5, -2, -1, -2, -5, -10]), dtype='float32' )
...
def train_mdcnn( model_path='./model/MDCNN-I_3.h5', image_shape=(512, 512), n_images=1024, epochs=1024, batch_size=8, gpus=0 ):
    ...
    #input_layers, output_layers = prepare_data( glob.glob( '/data/wallpapers/mandelbrot_*/*.jpg'), image_shape, n_images )
...
if __name__ == '__main__':
    train_mdcnn( gpus=1, n_images=2048, epochs=32, batch_size=1 )
