...
def build_model(input_shape=(None,None,1), output_channels=1, regular_factor=1.0e-5 ):
    ...
    last512 = Conv2D(output_channels , kernel_size=(31, 31), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_512" )( llast )

    last4 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( lx4 )
    last4 = Conv2D(output_channels , kernel_size=(3, 3), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_4")( last4 )

    last8 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( l9 )
    last8 = Conv2D(output_channels , kernel_size=(5, 5), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_8")( last8 )

    last16 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( l12 )
    last16 = Conv2D(output_channels , kernel_size=(5, 5), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_16")( last16 )

    last32 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( l15 )
    last32 = Conv2D(output_channels , kernel_size=(7, 7), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_32" )( last32 )

    last64 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( l18 )
    last64 = Conv2D(output_channels , kernel_size=(9, 9), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_64" )( last64 )

    last128 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( l21 )
    last128 = Conv2D(output_channels , kernel_size=(11, 11), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_128" )( last128 )

    last256 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( l24 )
    last256 = Conv2D(output_channels , kernel_size=(17, 17), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="gen_256" )( last256 )

    pre_last256 = Conv2D(8 , kernel_size=(3, 3), activation='relu', strides=(1,1), padding='same', kernel_regularizer = kr )( l24 )
    pre_last256 = Conv2D(output_channels , kernel_size=(17, 17), activation='sigmoid', strides=(1,1), padding='same', kernel_regularizer = kr, name="pre_256" )( pre_last256 )
    ...
    return (normal_model, final_model)
