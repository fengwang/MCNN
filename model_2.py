...
def build_model( input_shape=(None, None, 1), output_channels=1, regular_factor=0.00001, initializer='he_normal', output_activation=sigmoid ):
    ...
    e_32  = make_blocks( make_pooling(e_64 ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )
    e_16  = make_blocks( make_pooling(e_32 ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )
    e_8   = make_blocks( make_pooling(e_16 ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )
    e_4   = make_blocks( make_pooling(e_8  ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )
    e_2   = make_blocks( make_pooling(e_4  ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )
    d_2   = e_2
    d_4   = add( [e_4,   make_blocks( make_upsampling(d_2  ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )] )
    d_8   = add( [e_8,   make_blocks( make_upsampling(d_4  ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )] )
    d_16  = add( [e_16,  make_blocks( make_upsampling(d_8  ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )] )
    d_32  = add( [e_32,  make_blocks( make_upsampling(d_16 ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )] )
    d_64  = add( [e_64,  make_blocks( make_upsampling(d_32 ), 512, ((3, 3), (5, 5), (7, 7), (9, 9))  )] )
    ...
    o_256 = make_output_block( d_256, (128, output_channels), (7, 7), output_activation=output_activation )
    o_128 = make_output_block( d_128, (256, output_channels), (5, 5), output_activation=output_activation )
    o_64  = make_output_block( d_64,  (512, output_channels), (3, 3), output_activation=output_activation )
    o_32  = make_output_block( d_32,  (512, output_channels), (3, 3), output_activation=output_activation )
    o_16  = make_output_block( d_16,  (512, output_channels), (3, 3), output_activation=output_activation )
    o_8   = make_output_block( d_8,   (512, output_channels), (3, 3), output_activation=output_activation )
    o_4   = make_output_block( d_4,   (512, output_channels), (3, 3), output_activation=output_activation )

    model = Model( inputs = init, outputs = [o_512, o_256, o_128, o_64, o_32, o_16, o_8, o_4] )
    model.summary()

    return model

if __name__ == '__main__':
    mdcnn = build_model( (512, 512, 1), output_channels = 3 )
