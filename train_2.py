...
def trim_image_from_path( image_path, shape ):
    ...
    try:
        ...
        print( f'Possibly currupted image: {image_path}' )
        return None
...
def train_mdcnn( model_path='./model/MDCNN-I_2.h5', image_shape=(512, 512), n_images=1024, epochs=1024, batch_size=8, gpus=0 ):
    ...
    mdcnn.fit( input_layers, output_layers, batch_size=batch_size, epochs=epochs, verbose=2,validation_split=0.25, callbacks=[tensor_board] )
...
if __name__ == '__main__':
    train_mdcnn( gpus=1, n_images=2048, epochs=32, batch_size=2 )
