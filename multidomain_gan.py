...
generator = build_model( (None, None, 33), output_channels=1 )
o_512, o_256, o_128 = generator( input_33 )

from discriminator import build_discriminator
discriminator = build_discriminator( (None, None, 1), output_channels = 1 )
...
dataset_path =f'/data/cache/astigmatism_hela_rand_{total}-input_1-output_33.npz'
...
for iteration in range( iterations ):
    ...
    for idx in range( int(total/batch_size) ):
        ...
        image_path = f'./astig_33_gan/_{iteration}_{idx}.png'
        imageio.imsave( image_path, np.squeeze( e_512 ) )
