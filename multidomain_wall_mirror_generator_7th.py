...
def build_model( input_shape=(None, None, 1), output_channels=1, regular_factor=0.00001, initializer='he_normal', output_activation=sigmoid ):
    ...
    d_1024 = make_blocks( make_upsampling(d_512, 32), 32,  ((3, 3), (5, 5), (7, 7), (9, 9))  )

    o_1024 = make_output_block( d_1024, (32,  output_channels), (9, 9), output_activation=output_activation )
    ...
    model = Model( inputs = init, outputs = [o_1024, o_512, o_256] )
    model.summary()
